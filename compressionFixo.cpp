...
vector<int> compression(string text, int bits=12){
    vector<int> out;
...
void decompression(vector<int> codein, int bits=12){
    unordered_map<string, string> table;
    for(int i=0; i<=255;i++){
